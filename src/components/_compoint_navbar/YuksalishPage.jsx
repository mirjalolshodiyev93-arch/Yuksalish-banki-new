...
const TelegramSection = () => (
  <div className="flex flex-col items-center bg-[#f8fafc] p-8 rounded-[35px] w-full lg:w-[360px] text-center shadow-sm border border-gray-100">
    <div className="relative mb-8 transform hover:-translate-y-2 transition-transform duration-500">
      {/* Telefon ramkasi */}
      <div className="w-[190px] h-[380px] bg-white rounded-[35px] border-[6px] border-[#1e293b] shadow-2xl overflow-hidden relative">
        <div className="absolute top-0 w-full h-full bg-[#008141] flex items-center justify-center">
           <span className="text-white text-[10px] font-bold opacity-40">TELEGRAM INTERFACE</span>
        </div>
      </div>
    </div>
    <h3 className="text-xl font-bold text-gray-800 mb-8 leading-snug">
      Yuksalish bank Telegram-kanaliga obuna bo'ling
    </h3>
