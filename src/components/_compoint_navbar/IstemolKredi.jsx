                ...
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={`w-full py-4 rounded-2xl font-bold text-white transition-all shadow-lg flex items-center justify-center ${loading ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700 shadow-blue-200'}`}
                    >
