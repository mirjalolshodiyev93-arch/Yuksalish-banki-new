          ...
          <div className="max-w-6xl mx-auto pt-[100px]">
            ...
            <div className="flex flex-col items-center justify-between gap-6 mb-10 md:flex-row" data-aos="fade-down">
              ...
              <div className="flex gap-8 px-6 py-4 bg-white border shadow-sm dark:bg-gray-900 rounded-3xl border-slate-100 dark:border-gray-800">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 dark:text-gray-500 uppercase font-bold tracking-widest">{t("gbpPage.sell")}</p>
                  <p className="text-2xl font-black text-rose-700">{sellRate.toLocaleString()} UZS</p>
                </div>
              </div>
            </div>
                  ...
                  <div className="h-[300px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={chartData}>
                        ...
                        />
                        <Area type="monotone" dataKey="rate" stroke="#be123c" strokeWidth={4} fillOpacity={1} fill="url(#colorGBP)" />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
